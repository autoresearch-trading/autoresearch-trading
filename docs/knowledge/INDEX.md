...
- [Session-of-Day Leakage](concepts/session-of-day-leakage.md) — leak vectors via `_last` flat features and raw-sequence timing; mitigations
...
- [Gate 1 Thresholds Revised](decisions/gate1-thresholds-revised.md) — 4-condition binding: 51.4% + beat Majority+1pp + beat RP+1pp + hour-of-day probe <10%
...
- [Gate 0 4-Baseline Grid](experiments/gate0-4baseline-grid.md) — PCA ≈ Majority ≈ RP on balanced acc; pipeline clean (shuffled≈0.500); raw-vs-balanced inflated H10 up to 9.9pp
