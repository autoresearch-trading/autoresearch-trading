...
class DeploymentSettings(BaseSettings):
    ...
    enable_health_checks: bool = Field(default=True, validation_alias="ENABLE_HEALTH_CHECKS")
    metrics_endpoint: str | None = Field(default=None, validation_alias="METRICS_ENDPOINT")
