...
def _write_md_report(
    ...
    lines: list[str] = [
        ...
        "Balanced accuracy is the council-preferred reading at ALL horizons. "
        "Raw accuracy preserved for historical comparison.",
        "",
    ]
    ...
    # Per-symbol results — both raw and balanced columns
